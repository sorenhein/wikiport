#!python3
"""Interfaces with Affinity API to put deal descriptions."""
...
def get_args():
  ...
  if l == 3:
    ...
    print("Usage: python3 descrip.py wiki.csv aff.csv")
    sys.exit()
...
# Field ID of "Description (Legacy)", hardwired
descr_no_id = 504493
...
for wno in wiki_map:
  ...
  if wno not in aff_map:
    ...
    if wdesc == adesc:
      ...
      num_diff += 1
      print("%4d, different %s, %s" % (n, wdesc, adesc))
